...
class TSqlDBQueryBuilderRepository extends TSqlDBConnectionRepository
    implements DBQueryBuilderRepositoryInterface
{
    ...
    {
        echo "Элемент добавлен в бд TSql";
    }
    ...
    {
        echo "Элемент изменен в бд TSql";
    }
    ...
    {
        echo "Элемент удален из бд TSql";
    }
}